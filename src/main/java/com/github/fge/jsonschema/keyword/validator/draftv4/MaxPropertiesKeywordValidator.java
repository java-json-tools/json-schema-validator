...
import com.github.fge.jsonschema.keyword.validator.helpers.PositiveIntegerKeywordValidator;
...
{
    public MaxPropertiesKeywordValidator(final JsonNode digest)
    {
        ...
        throws ProcessingException
    {
        ...
        if (size > intValue)
            report.error(newMsg(data).msg(TOO_MANY_MEMBERS_IN_OBJECT)
