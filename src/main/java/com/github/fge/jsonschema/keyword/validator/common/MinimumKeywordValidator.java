...
import com.github.fge.jsonschema.keyword.validator.helpers.NumericKeywordValidator;
    ...
    extends NumericKeywordValidator
{
    ...
    public MinimumKeywordValidator(final JsonNode digest)
    {
        ...
        throws ProcessingException
    {
        ...
        if (instanceValue < longValue) {
            report.error(newMsg(data).msg(NUMBER_TOO_SMALL).put(keyword, number)
                .put("found", instance));
            return;
        }
        ...
        report.error(newMsg(data).msg(NUMBER_EX_SMALL).put(keyword, number)
