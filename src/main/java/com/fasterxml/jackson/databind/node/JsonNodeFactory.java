/*
 * File copied from jackson-databind. This file is licensed under the Apache
 * software license. See:
 *
 * https://github.com/FasterXML/jackson-databind
 *
 * The only modification in this file is in .decimalNode(), where the BigDecimal
 * passed as an argument is stripped off its trailing zeroes. This allows nodes
 * "1.00" and "1.0" to be equal (they were not otherwise).
 */
