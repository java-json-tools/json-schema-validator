...
public final class DependenciesKeywordValidatorTest
{
    ...
    @DataProviderArguments(fileName = "/keyword/dependenciesSimple.json")
    public void testDependenciesSimple(final JsonNode node)
    {
        ...
        final KeywordValidator validator
            = new DependenciesKeywordValidator(schemaNode);
    ...
    @DataProviderArguments(fileName = "/keyword/dependenciesSchema.json")
    public void testDependenciesSchema(final JsonNode node)
    {
        final JsonNode schemaNode = node.get("schema");
        final JsonNode data = node.get("data");
        final boolean valid = node.get("valid").booleanValue();
