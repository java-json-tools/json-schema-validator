...
{
    private static final Class<NonAbsoluteSchemaUris> myself
        = NonAbsoluteSchemaUris.class;
    ...
    {
        final URIDownloader downloader = new URIDownloader()
        {
            @Override
                ...
                throws IOException
            {
                ...
                final InputStream in = myself.getResourceAsStream(path);
        ...
        final JsonSchemaFactory factory = new JsonSchemaFactory.Builder()
            .registerScheme("resource", downloader)
