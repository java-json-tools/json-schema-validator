...
import eel.kitchen.jsonschema.v2.instance.ObjectInstance;
...
public final class Foobar3
{
    ...
    static {
        try {
            testNode = JasonHelper.load("/v2/test2.json");
        } catch (IOException e) {
    ...
    private static void operateOne(final JsonNode element)
    {
        ...
        final Instance instance = new ObjectInstance(element);
